    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <aside className="w-64 bg-white shadow-md p-4 flex flex-col">
        ...
        <nav className="flex flex-col gap-3">
          <button className="text-left px-3 py-2 rounded-lg bg-teal-600 text-white font-medium">
            Dashboard
          </button>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          <Card>
            <CardContent className="p-4">
              ...
              <span className="text-green-600 text-xs">+12% em relação ao mês anterior</span>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <span className="text-red-500 text-xs">Requer atenção imediata</span>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <span className="text-green-600 text-xs">+8.2% comparado ao mês anterior</span>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <span className="text-gray-500 text-xs">Produtos vencem em 30 dias</span>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent className="p-4">
              ...
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-red-50 border border-red-200">
                  ...
                  <p className="text-sm text-gray-600">Estoque crítico: 5 unidades</p>
                </div>
                ...
                <div className="p-3 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-sm text-gray-600">Alta demanda detectada</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <ul className="space-y-3 text-sm">
                <li>
                  <span className="font-medium">Entrada de estoque:</span> Amoxicilina 500mg - 100 unidades 
                  <span className="text-gray-500 ml-2">2h atrás</span>
                </li>
                <li>
                  <span className="font-medium">Venda realizada:</span> Paracetamol 750mg - 2 unidades 
                  <span className="text-gray-500 ml-2">4h atrás</span>
                </li>
                <li>
                  <span className="font-medium">Ajuste de estoque:</span> Losartana 50mg - Correção manual 
